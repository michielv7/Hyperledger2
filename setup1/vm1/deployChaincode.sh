...
presetup() {
    ...
    pushd ./../../artifacts/src/github.com/fabroom/go
...
VERSION="1"
CC_SRC_PATH="./../../artifacts/src/github.com/fabroom/go"
CC_NAME="fabroom"
...
approveForMyOrg1() {
    ...
    peer lifecycle chaincode approveformyorg -o 207.154.235.178:7050 \
...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
        --peerAddresses localhost:11051 --tlsRootCertFiles $PEER0_ORG3_CA \
        -c '{"function": "createRoom","Args":["TESTROOM", "1200€", "200€", "Jozef Dederde", "Michiel Verbeke"]}'
...
chaincodeQuery() {
    ...
    # Query Car by Id
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "queryRoom","Args":["TESTROOM"]}'
